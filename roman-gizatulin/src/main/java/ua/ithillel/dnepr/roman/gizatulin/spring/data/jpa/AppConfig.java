...
@EnableJpaRepositories(
        basePackages = {
                "ua.ithillel.dnepr.roman.gizatulin.spring.data.jpa.repository"
        }
)
@EnableTransactionManagement
@ComponentScan(
        basePackages = {
                "ua.ithillel.dnepr.roman.gizatulin.spring.data.jpa",
                "ua.ithillel.dnepr.roman.gizatulin.spring.data.jpa.entity"
        }
)
