package ua.ithillel.dnepr.yuriy.shaynuk.spring.data.jpa;
...
@EnableJpaRepositories(
        basePackages = {
                "ua.ithillel.dnepr.yuriy.shaynuk.spring.data.jpa.repository"
        }
)
@EnableTransactionManagement
@ComponentScan(
        basePackages = {
                "ua.ithillel.dnepr.yuriy.shaynuk.spring.data.jpa",
                "ua.ithillel.dnepr.yuriy.shaynuk.spring.data.jpa.entity"
        }
)
